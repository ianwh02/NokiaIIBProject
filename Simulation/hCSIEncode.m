...
%   DMRSConfig      - Demodulation reference signal (DM-RS) configuration
%                     object for the physical downlink shared channel
%                     (PDSCH), as described in <a href="matlab:help('nrPDSCHDMRSConfig')">nrPDSCHDMRSConfig</a>.
...
%   Copyright 2022-2024 The MathWorks, Inc.
    ...
    if alg.CSIReportMode == "RI-PMI-CQI"
        ...
        csiReport = hCSISelect(carrier,csirs,alg.DMRSConfig,alg.CSIReportConfig,H,nVar,alg);
    else
...
function csi = hCSISelect(carrier,csirs,dmrsConfig,reportConfig,H,nVar,alg)
    ...
    rank = hRISelect(carrier,csirs,dmrsConfig,reportConfig,H,nVar,'MaxSE');
    ...
    [cqi,pmi,~,pmiInfo] = hCQISelect(carrier,csirs,dmrsConfig,reportConfig,rank,H,nVar);
