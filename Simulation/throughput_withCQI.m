...
simParameters.NFrames = 2;      % Number of 10 ms framesPDSCHconfig
simParameters.SNRIn = [-5 0 5 10]; % SNR range (dB)
...
simParameters.TransmitAntennaArray.PanelDimensions  = [4 1]; % Number of columns and rows in the transmit panel (N1, N2)
...
disp(simParameters.NTxAnts);
disp(simParameters.NRxAnts);

%CSI-RS Configuration
simParameters.CSIRS = nrCSIRSConfig;
simParameters.CSIRS.CSIRSType = 'nzp'; % 'nzp','zp'
simParameters.CSIRS.RowNumber = 6; % 4 for 4 ports, 6 for 8 ports
